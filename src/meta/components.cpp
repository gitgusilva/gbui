...
std::vector<ComponentInfo> build() {
    ...
    out.push_back(ComponentInfo{
        ...
        "MenuItemOptions",
        {
            ...
            PropertyInfo{"positionInSet", PropertyKind::Number, "std::size_t", "0", {}, "Its place in the list, one-based, and how long the list is. Zero on both is \"not one of a set\", which is right for a menu: a reader walking commands does not want them counted. A `select` sets them, and a *filtered* select sets them from what is shown — \"3 of 40\" in a list narrowed to four is three lies in five words.", false},
            PropertyInfo{"setSize", PropertyKind::Number, "std::size_t", "0", {}, "", false},
        },
        false,
        true,
