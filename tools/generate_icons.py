...
def main():
    ...
    # The first line has to carry the word GENERATED: CI's clang-format gate
    # skips a file whose *first* line says so, and neither of these two said it
    # — so the formatter kept asking for a generated table to be rewrapped, and
    # the next regeneration would have undone the rewrapping anyway.
    header = ['// GENERATED by tools/generate_icons.py — do not edit.',
              '//',
    ...
    source = ['// GENERATED by tools/generate_icons.py — do not edit.',
              '',
